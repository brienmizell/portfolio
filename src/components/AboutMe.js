...
const AboutMe = () => {
  return (
    <div id="about-me">
      ...
      <p>
        In a way, I have always been a programmer, per se. I always enjoyed
        programming my life and making edits so that my life would run smoothly
        and implementing life-hacks so that it could be as efficient as
        possible. Once introduced to computers, I would love searching for ways
        they could make my life simpler or more enriched. I am now writing those
        apps to help others live a better life and be more connected to the
        world around them.
      </p>
      <p>
        I started programming CNC machines for cutting out precision parts to
      ...
      <p>
        ...
        and long hours, because any job worth doing is worth doing right.{" "}
      </p>
    </div>
  );
};
